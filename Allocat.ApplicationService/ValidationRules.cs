...
namespace Allocat.ApplicationService
{
    ...
    public class ValidationRules
    {
        ...
        public Boolean ValidateNumericForTable(object entity, string friendlyName)
        {
        ...
        public Boolean ValidateIsDateForTable(object entity, string friendlyName)
        {
        ...
        public Boolean ValidateIsDateOrNullOrEmptyDateForTable(object entity, string friendlyName)
        {
