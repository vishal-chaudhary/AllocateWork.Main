...
{
    public class PreservationTypeController : ApiController
    {
        IProductDataService productDataService;

        public PreservationTypeController()
        {
        ...
        public HttpResponseMessage Get()
        {
            ...
            List<string> PreservationTypes = productBusinessService.GetPreservationTypes(out transaction);

            rfq_TissueBankApiModel.PreservationTypes = PreservationTypes;
